...
app.post('/api/startdonation', async (req, res) => {
	{
		'use strict';
		...
		Fabric_Client.newDefaultKeyValueStore({
			...
			var request = {
				...
				args: [req.body.VolunteerName, req.body.CampName,req.body.ProjectName,req.body.DoneeName,req.body.ScanAsset],
			...
			if (isProposalGood) {
				...
				let event_hub = channel.newChannelEventHub(gcpeer);
